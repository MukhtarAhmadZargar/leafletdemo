...
map.on(L.Draw.Event.CREATED, function (event) {
  ...
  bnds = layer.getBounds();
  // bnds._southWest
  // console.log(map.getCenter(),"size",map.getSize(),"bounds", layer.getBounds())
  map.fitBounds(layer.getBounds());
  // console.log(bnds._northEast.lat) 
  // console.log(bnds._northEast.lng)  
  // map.setView([bnds._northEast.lat, bnds._northEast.lng], 17);
...
// map.setView([layer.getBounds()], zoom);
